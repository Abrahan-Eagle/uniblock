...
@section('content')
    ...
    <section id="home" class="video-hero js-fullheight"
        style="height: 700px; background-image: url(/images/front/banner/blog_detail.jpg);  background-size:cover; background-position: center center;background-attachment:fixed;"
        data-section="home">
            ...
            <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center"
                ...
                <div class="col-md-10 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                    <p class="breadcrumbs mb-2" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span><a
                                href="{{ url('/') }}">Home -></a></span> <span><a href="{{ url('/blog') }}">Blog -></a></span>
                ...
                <div class="col-md-8 ftco-animate fadeInUp ftco-animated">
                    ...
                    @if ($post -> url_video == true)
                        <div class="sermons2" style="margin-bottom: 0em">
                            <a type="button" class="img mb-3 d-flex justify-content-center align-items-center" style="background-image: url(/images/front/blog/{{ $post -> img }});" data-toggle="modal" data-target="#exampleModal2">
                    ...
                    @elseif ($post -> url_video == null)
                        <div class="">
                            <p><img src="/images/front/blog/{{ $post->img }}" alt="" class="img-responsive mx-auto img-fluid img mb-3 d-flex justify-content-center align-items-center"></p>
                        </div>
                        ...
                        <div class="meta">
                          ...
                          <div><a href="#"><span class="icon-chat"></span> {{ count($comment) }}</a></div>
                            ...
                            <div><a 
                                ...
                                @endforeach
                            href="{{ route('blog.like', ['slug' => $post->slug]) }}"><span class="icon-thumbs-up"></span>
                            ...
                            <div><a 
                                ...
                                @endforeach
                                href="{{ route('blog.dislike', ['slug' => $post->slug]) }}"><span class="icon-thumbs-down"></span>
                ...
                <div class="col-md-4 sidebar ftco-animate order-first fadeInUp ftco-animated">
                    ...
                    <div class="sidebar-box ftco-animate fadeInUp ftco-animated">
                        <div class="categories">
                            ...
                            @foreach ($categories as $category)
                                <li><a href="{{ route('blog.categories', ['slug' => $category->slug]) }}">{{ $category->title }}
                    ...
                    <div class="sidebar-box ftco-animate fadeInUp ftco-animated">
                        ...
                        @foreach ($recentpost as $recentposts)
                            ...
                            <div class="block-21 mb-4 d-flex">
                                <a href="{{ route('blog.post', ['slug' => $recentposts->slug]) }}" class="blog-img mr-4"
                                    style="background-image: url(/images/front/blog/{{ $recentposts->img }});"></a>
                                <div class="text">
                                    <h3 class="heading"><a
                                            href="{{ route('blog.post', ['slug' => $recentposts->slug]) }}">{!!
                ...
                <div class="text">
                  ...
                  <div class="meta">
                    ...
                    <div class="sidebar-box ftco-animate fadeInUp ftco-animated">
                        ...
                        <div class="tagcloud">
                            @foreach ($tags as $tag)
                                <a href="{{ route('blog.tags', ['slug' => $tag->slug]) }}"
                                    class="tag-cloud-link">{{ $tag->title }}</a>
                            @endforeach
                        </div>
                    </div>
