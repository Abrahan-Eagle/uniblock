            ...
            <div class="row">
                <div class="col-md-8 ftco-animate fadeInUp ftco-animated">
                    ...
                    @elseif ($post -> url_video == null)
                        <div class="">
                            <p><img src="/images/front/event/{{ $post->img }}" alt="" class="img-responsive mx-auto img-fluid img mb-3 d-flex justify-content-center align-items-center"></p>
                        </div>
                    ...
                    <div class="tag-widget post-tag-container mb-1 mt-1">
                        <h5>Categorias</h5>
                        <div class="tagcloud">
                            <a href="{{ route('event.category', ['slug' => $post->category->slug]) }}"
                    ...
                    <div class="tag-widget post-tag-container  mb-1 mt-1">
                        ...
                        <div class="tagcloud">
                            @foreach ($post->tags as $tag)
                                <a href="{{ route('event.tag', ['slug' => $tag->slug]) }}"
                ...
                <div class="col-md-4 sidebar ftco-animate order-first fadeInUp ftco-animated">
                    <div class="sidebar-box">
                        <form action="{{ URL::to('/events') }}" method="GET" class="search-form">
                            <div class="form-group">
                    ...
                    <div class="sidebar-box ftco-animate fadeInUp ftco-animated">
                        <div class="categories">
                            ...
                            @foreach ($categories as $category)
                                <li><a href="{{ route('event.categories', ['slug' => $category->slug]) }}">{{ $category->title }}
                    ...
                    <div class="sidebar-box ftco-animate fadeInUp ftco-animated">
                        ...
                        @foreach ($recentpost as $recentposts)
                            ...
                            <div class="block-21 mb-4 d-flex">
                                <a href="{{ route('event.post', ['slug' => $recentposts->slug]) }}" class="blog-img mr-4"
                                    style="background-image: url(/images/front/event/{{ $recentposts->img }});"></a>
                                <div class="text">
                                    <h3 class="heading"><a
                                            href="{{ route('event.post', ['slug' => $recentposts->slug]) }}">{!!
                                            substr($recentposts['title'], 0, 40) !!}</a></h3>
                                    <div class="meta">
                                        <div><a href="#"><span class="icon-calendar"></span>
                                                {{ date('d M Y', strtotime($recentposts->date_activi)) }}</a></div>
                                        <!-- <div><a href="#"><span class="icon-person"></span> Admin</a></div>
                ...
                <div class="text">
                  ...
                  <div class="meta">
                    ...
                    <div class="sidebar-box ftco-animate fadeInUp ftco-animated">
                        ...
                        <div class="tagcloud">
                            @foreach ($tags as $tag)
                                <a href="{{ route('event.tags', ['slug' => $tag->slug]) }}"
                                    class="tag-cloud-link">{{ $tag->title }}</a>
                            @endforeach
                        </div>
                    </div>
