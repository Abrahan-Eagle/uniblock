  ...
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
      <div class="col-md-10 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
        <p class="breadcrumbs mb-2" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span><a href="{{url('/')}}">Home</a></span> <span class="mr-2">Predicas y Estudios</span></p>
        <h1 class="mb-3 mt-0 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Predicas y Estudios</h1>
      </div>
    </div>
  </div>
</section>
      ...
      <div class="col-md-4 ftco-animate">
        <div class="blog-entry">
          ...
          <div class="text p-4 d-block">
            ...
            <h3 class="heading"><a href="{{ route('sermon.post', $post->slug) }}">{!! substr($post['title'], 0, 63) !!}</a></h3>
          </div>
        </div>
      </div>
