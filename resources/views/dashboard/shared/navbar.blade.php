...
-->
      ...
      <li class="c-header-nav-item dropdown d-md-down-none mx-2"><a class="c-header-nav-link" data-toggle="dropdown"
        ...
        <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg pt-0">
          <div class="dropdown-header bg-light"><strong>You have 4 messages</strong></div><a class="dropdown-item"
            ...
            <div class="message">
              <div class="py-3 mfe-3 float-left">
                <div class="c-avatar"><img class="c-avatar-img" src="{{asset('assets/img/avatars/5.jpg')}}"
            ...
            <div class="message">
              <div class="py-3 mfe-3 float-left">
                <div class="c-avatar"><img class="c-avatar-img" src="{{asset('assets/img/avatars/4.jpg')}}"
    ...
    -->
      ...
      <li class="c-header-nav-item dropdown"><a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button"
          ...
          <div class="c-avatar"><img class="c-avatar-img" src="/images/user/{{auth()->user() -> profile_pic}}"
              alt="{{auth()->user() -> email}}">
          </div>
        </a>
        <div class="dropdown-menu dropdown-menu-right pt-0">
      ...
      <button class="c-header-toggler c-class-toggler mfe-md-3">
