    ...
    <div class="col-md-12">
        <div id="ui-view">
            <div>
                <div class="fade-in">
                    <div class="card">
                        <div class="card-header"> Listas de Etiquetas de Blog
                            <div class="card-header-actions"><a class="card-header-action"
                                    href=" {{ route('tags.create', ['level' => 'blog']) }} "><small class="text-muted">CREAR
                                                    ...
                                                    <tr role="row" class="odd"
                                                        ...
                                                        <td>
                                                            ...
                                                            <a class="btn btn-dark"
                                                                href="{{ route('tags.show', ['level' => 'blog', 'id' => $tag->id]) }}"><svg
                                                            ...
                                                            <a class="btn btn-info"
                                                                href="{{ route('tags.edit', ['level' => 'blog', 'id' => $tag->id]) }}"><svg
                                                                    class="c-icon">
                                                                    <use
                                                                        xlink:href="{{ asset('icons/sprites/free.svg#cil-description') }}">
                                                                    </use>
                                                            ...
                                                            <div class="col-sm-2">
                                                                <form method="POST" action="{{ route('tags.destroy', ['level' => 'blog', 'id' => $tag->id]) }}">
                                                                    @csrf
