    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-body p-4">
                <h1 class="text-muted">Crear categoria de evento</h1>
            </div>
            <form  action="{{ route('categories-event.store') }}" method="post" class="needs-validation" accept-charset="UTF-8" enctype="multipart/form-data">
                @csrf
