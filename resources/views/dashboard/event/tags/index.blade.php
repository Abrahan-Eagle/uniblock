    ...
    <div class="col-md-12">
        <div id="ui-view">
            <div>
                <div class="fade-in">
                    <div class="card">
                        <div class="card-header"> Listas de Etiquetas de los Eventos
                            <div class="card-header-actions"><a class="card-header-action"
                                    href=" {{ route('tags-event.create', ['level' => 'event']) }} "><small class="text-muted">CREAR
                                                    ...
                                                    <tr role="row" class="odd"
                                                        ...
                                                        <td>
                                                            ...
                                                            <a class="btn btn-dark"
                                                                href="{{ route('tags-event.show', ['level' => 'event', 'id' => $tag->id]) }}"><svg
                                                            ...
                                                            <a class="btn btn-info"
                                                                href="{{ route('tags-event.edit', ['level' => 'event', 'id' => $tag->id]) }}"><svg
                                                                    class="c-icon">
                                                                    <use
                                                                        xlink:href="{{ asset('icons/sprites/free.svg#cil-description') }}">
                                                                    </use>
                                                            ...
                                                            <div class="col-sm-2">
                                                                <form method="POST" action="{{ route('tags-event.destroy', ['level' => 'event', 'id' => $tag->id]) }}">
                                                                    @csrf
