                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-1">
                            <div class="logo">
                                <a href="index.html"><img src="{{ asset('uniblock/img/logo/logo.png') }} " alt=""></a>
                            </div>
                        </div>
                        <div class="col-xl-10 col-lg-10 col-md-10">
                            <div class="menu-main d-flex align-items-center justify-content-end">
                                ...
                                <div class="main-menu f-right d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            <li><a href="index.html">Homexxxxxxxxx</a></li>
                                            <li><a href="about.html">Acerca de</a></li>
                                            <li><a href="spakers.html">Nuestro Equipo</a></li>
                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-8 col-md-9 col-sm-10">
                                <div class="hero__caption">
                                    ...
                                    <h1 data-animation="fadeInLeft" data-delay=".5s">Tecnologia - Uniblock</h1>
                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-8 col-md-9 col-sm-10">
                                <div class="hero__caption">
                                    ...
                                    <h1 data-animation="fadeInLeft" data-delay=".5s"> Inteligencia Artificial <p>Solo una Herramienta.</p></h1>
                                    <!-- Hero-btn -->
                                    <div class="slider-btns">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-9">
                        ...
                        <div class="section-tittle section-tittle2 mb-50">
                            ...
                            <a href="#" class="btn white-btn mt-30">Nuestro Equipo</a>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-5">
                            <div class="single-footer-caption mb-50">
                                <div class="footer-tittle">
                                    <h4>Links</h4>
                                    <ul>
                                        <li><a href="#">Nuestros Projectos</a></li>
                         ...
                         <div class="row d-flex justify-content-between align-items-center">
                             <div class="col-xl-10 col-lg-8 ">
                                 <div class="footer-copy-right">
                                     <p>
      Copyright &copy;<script>document.write(new Date().getFullYear());</script> Reservados todos los derechos | Tecnologia  <i class="fa fa-heart" aria-hidden="true"></i><a href="https://uniblock.io" target="_blank"> UniBlock </a></p>
                                 </div>
                             </div>
